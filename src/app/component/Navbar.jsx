...
export default function AppNavbar() {
  ...
  const navLinks = [...baseLinks, ...protectedLinks];
  const isActive = (href) => pathname === href;
          ...
          <div className="flex items-center gap-4">
            {!user ? (
              ...
              <div className="flex items-center gap-4">
                ...
                <Link
                  href="/register"
                  className="hidden md:block text-sm font-medium bg-[#f97316] text-white px-4 py-2 rounded-xl hover:bg-[#ea580c] transition-colors"
                >
                  Register
                </Link>
              </div>
              ...
              <div className="relative">
                ...
                {dropdownOpen && (
                  <div className="absolute right-0 mt-2 w-52 bg-white dark:bg-[#141414] border border-gray-200 dark:border-white/[0.08] rounded-xl shadow-2xl p-1 flex flex-col z-50">
                    <div className="px-3 py-2 border-b border-gray-100 dark:border-white/[0.06]">
                    ...
                    <button
                      className="px-3 py-2 text-sm text-red-500 hover:bg-red-50/10 rounded-lg transition-colors text-left font-medium"
        ...
        <div className="sm:hidden fixed inset-x-0 top-16 bg-white dark:bg-[#0d0d0d]/95 backdrop-blur-xl border-b border-gray-200 dark:border-white/[0.06] pt-4 pb-6 px-4 flex flex-col gap-1 shadow-lg">
          ...
          {user ? (
            ...
            <>
              ...
              <Link
                href="/register"
                className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium bg-[#f97316] text-white transition-colors"
                onClick={() => setMobileMenuOpen(false)}
              >
                Register
              </Link>
